...
<div class="span6">
<?php endif; ?>
<?php if ($this->params->get('presentation_style') =='plain' && $this->contact->image && $this->params->get('show_image')) : ?>
    <div class="thumbnail">
  ...
  <?php endif; ?>
    ...
    <?php endif; ?>
    <?php if ($this->params->get('presentation_style') =='plain' && $this->params->get('show_links')):?>
	...
	<?php if ($this->params->get('show_email_form') && ($this->contact->email_to || $this->contact->user_id)) : ?>
		...
		<?php endif; ?>
		<?php if ($this->params->get('presentation_style')=='plain'):?>
            <div class="contact-form-wrap span6">
