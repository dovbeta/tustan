...
<div class="page-header">
	...
	/**
	* Explode page heading
	*/ 
	$page_headings = explode(" ",$this->escape($this->params->get('page_heading')));
	echo '<span>'.$page_headings[0].'</span> ';
	unset($page_headings[0]);
	echo implode(" ",$page_headings);
	?>
	</h1>
</div>
<?php endif; ?>
