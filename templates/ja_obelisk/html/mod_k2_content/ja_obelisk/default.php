...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul>
	...
	?>
    <li class="clearfix <?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
	  <!-- add number -->
      ...
      <div class="k2Avatar moduleItemAuthorAvatar clearfix">
      ...
      <div class="moduleItemExtraFields">
	      ...
	      <ul>
	        <?php foreach ($item->extra_fields as $extraField): ?>
					...
					<li class="clearfix type<?php echo ucfirst($extraField->type); ?> group<?php echo $extraField->group; ?>">
						...
						<span class="moduleItemExtraFieldsValue">
                            <?php
                            //Override extrafield value as search labels
