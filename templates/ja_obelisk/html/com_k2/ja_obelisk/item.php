...
<div id="k2Container" class="row itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?> clearfix">
	
	<?php if(($this->item->params->get('itemImage') && !empty($this->item->image)) || ($this->item->params->get('itemVideo') && !empty($this->item->video))): ?>
  <!-- Item Image -->
  ...
  <div class="itemViewContent span8 pull-right">
	  ...
	  <?php echo $this->item->event->K2BeforeDisplayContent; ?>
	    ...
	    <?php if(!empty($this->item->fulltext)): ?>
		  ...
		  <div class="itemFullText">
		  	<?php echo JAObeliskHelper::photogallery($this->item->fulltext,'span2'); ?>
		  </div>
		  <?php endif; ?>
	    <?php else: ?>
            <!-- Item text -->
